    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onCancel}>
      <View className="flex-1 bg-black/30 items-center justify-center px-8">
        <View className="bg-white rounded-2xl w-full max-w-xs p-6 items-center">
          ...
          <Text className="font-khmerBold text-gray-900 text-xl text-center" maxFontSizeMultiplier={1.3}>
            បញ្ជាក់ការទិញជោគជ័យ!
          </Text>
          <Text className="font-khmer text-gray-400 text-xl text-center mt-1.5" maxFontSizeMultiplier={1.3}>
          ...
          >
            <Text className="font-khmerBold text-white text-xl" maxFontSizeMultiplier={1.3}>យល់ព្រម</Text>
          </TouchableOpacity>
