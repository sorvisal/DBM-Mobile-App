...
export function CustomerSpendingCard({
  customer,
  onViewHistory,
  ...
  return (
    <View>
      ...
      <View className="flex-row gap-3 mb-5">
        ...
        {/* Total Orders */}
        <Pressable
          onPress={() => onViewHistory(customer.id)}
          className="flex-1 bg-white rounded-2xl p-4 items-center border border-gray-50 shadow-black/5 shadow-sm"
        >
        ...
        {/* Total Spending */}
        <View className="flex-1 bg-white rounded-2xl p-4 items-center border border-gray-50 shadow-black/5 shadow-sm">
      ...
      <Text className="font-khmerBold text-gray-900 text-xl mb-2 mt-3">
        ព័ត៌មានបន្ថែម
      </Text>
